...
function getPercentage() {
    ...
    $.ajax(settings).done(function (response) {
        ...
        $("#result").text(response.percentage + "%");
        console.log(response);
        console.log(response.percentage);
        if (response.percentage >= 97) {
        ...
        } else if (response.percentage >= 90 && response.percentage <= 96) {
        ...
        } else if (response.percentage >= 80 && response.percentage <= 89) {
        ...
        } else if (response.percentage >= 75 && response.percentage <= 79) {
        ...
        } else if (response.percentage >= 70 && response.percentage <= 74) {
        ...
        } else if (response.percentage >= 65 && response.percentage <= 69) {
        ...
        } else if (response.percentage >= 60 && response.percentage <= 64) {
        ...
        } else if (response.percentage >= 55 && response.percentage <= 59) {
        ...
        } else if (response.percentage >= 50 && response.percentage <= 54) {
        ...
        } else if (response.percentage >= 45 && response.percentage <= 49) {
        ...
        } else if (response.percentage >= 40 && response.percentage <= 44) {
        ...
        } else if (response.percentage >= 35 && response.percentage <= 39) {
        ...
        } else if (response.percentage >= 28 && response.percentage <= 34) {
        ...
        } else if (response.percentage >= 21 && response.percentage <= 27) {
        ...
        } else if (response.percentage >= 14 && response.percentage <= 20) {
        ...
        } else if (response.percentage >= 7 && response.percentage <= 13) {
